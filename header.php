...
<html lang="en">
    ...
    <body class="app sidebar-mini">
            ...
            <ul class="app-nav">
                ...
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu settings-menu dropdown-menu-right">
                    ...
                    <li>
                        <a onclick="return confirm('You are sure! you want to logout?')" class="dropdown-item" href="signout.php">
        ...
        <aside class="app-sidebar">
            <?php
            $qry = "SELECT roles.name as 'rname', users.name as 'uname', users.profile as 'uprofile' FROM model_has_roles 
                                INNER JOIN users ON users.id = model_has_roles.user_id
            ...
            ?>
            <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="<?= $admin[0]['uprofile']; ?>" alt="User Image" width="50" height="50">
                <div>
                  <p class="app-sidebar__user-name"><?= $admin[0]['uname'] ?></p>
                  <p class="app-sidebar__user-designation"><?= $admin[0]['rname'] ?></p>
                </div>
            </div>
            ...
            <ul class="app-menu">
                ...
                <li>
                    <a onclick="return confirm('Are you sure you want to logout?')" class="app-menu__item" href="signout.php">
                        <i class="icofont-logout app-menu__icon"></i>
                        <span class="app-menu__label">
                            Logout
                        </span>
                    </a>
